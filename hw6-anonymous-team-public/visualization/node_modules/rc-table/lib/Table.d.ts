...
import type { ColumnsType, ColumnType, DefaultRecordType, ExpandableConfig, GetComponentProps, GetRowKey, LegacyExpandableProps, PanelRender, RowClassName, TableComponents, TableLayout, TableSticky } from './interface';
...
declare namespace Table {
    ...
    var Summary: typeof import("./Footer/Summary").default;
    var defaultProps: {
        rowKey: string;
        prefixCls: string;
        emptyText: () => string;
